...
**Date:** 2026-05-09
**Scope:** Bridge Phase 6A from [docs/v2/MOE_EXPERT_OVERLAY_PRODUCTION_EXECUTION_PLAN.md](MOE_EXPERT_OVERLAY_PRODUCTION_EXECUTION_PLAN.md): production dispatch descriptor consumption and sparse token-row transfer.
