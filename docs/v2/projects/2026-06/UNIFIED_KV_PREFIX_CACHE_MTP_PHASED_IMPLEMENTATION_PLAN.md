...
- Retained implementation work:
  ...
  - Stochastic SingleDevice CUDA/ROCm Qwen3.6 now uses grouped decode-equivalent stochastic verifier counters and explicitly asserts zero `phase138_stochastic_spec_decode_runs` for stateful rows that require replay.
