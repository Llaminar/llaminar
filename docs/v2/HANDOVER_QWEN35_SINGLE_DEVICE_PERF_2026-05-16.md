...
- `docs/v2/cleanup/MOE_OVERLAY_GRAPH_NATIVE_PRODUCTIONIZATION_PLAN.md`
...
- Benchmark/analysis assets added:
  ...
  - `docs/v2/perf/MOE_GRAPH_NATIVE_OVERLAY_BENCHMARK_ANALYSIS.md`
  - `docs/v2/MOE_GRAPH_NATIVE_OVERLAY_PRODUCTION_HARDENING.md`
