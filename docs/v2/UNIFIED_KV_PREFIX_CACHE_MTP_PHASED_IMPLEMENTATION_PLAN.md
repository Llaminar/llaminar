...
5. Next: re-run Qwen3.6 ROCm dense baseline/MTP benchmarks and update Phase 13.5 status with measured latency/throughput before returning to Phase 14 acceptance.
