...
- Next implementation gate: broaden the live candidate equivalence matrix across
  ...
  restore, and continuation cases on CUDA and ROCm, then add a benchmarkable
  no-oracle replay mode only after the equivalence harness proves the path is
