...
- Residual-batch dense default benchmarks show this was useful plumbing but not the dominant performance issue: CUDA reached 36.82 decode tok/s and ROCm reached 19.99 decode tok/s with about 61-62% acceptance. The next speed work should target verifier graph cost or acceptance behavior, not accept/residual sampling launch count.
