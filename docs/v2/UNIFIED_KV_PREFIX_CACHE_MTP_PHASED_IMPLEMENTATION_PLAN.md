...
- Next implementation slice:
  ...
  2. reduce ROCm M=2 verifier graph cost for stochastic depth-1/dynamic lanes, starting with GDN projection, fused gate/up, ordinary GEMM, fused QKV, and LM head counters before using stochastic MTP in Phase 14 dense acceptance;
