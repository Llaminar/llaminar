...
Measure whether prefix cache and MTP provide real speedups on the supported correctness matrix, after the Phase 13.5 small-M GEMV-many prerequisite and Phase 13.7 stochastic verifier prerequisite have landed for the backend under test. Phase 13.6 atomic transaction validation is now part of the correctness baseline for any MTP benchmark evidence.
...
17. Phase 14 benchmark acceptance matrix.
