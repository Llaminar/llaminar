...
- Next implementation gate: broaden the live candidate equivalence matrix across
  ...
  restore, and continuation cases on CUDA and ROCm, then collect direct-mode
  benchmark evidence without the oracle replay.
