...
Latest CUDA verifier-equivalence narrowing, 2026-06-06: focused CUDA regressions now prove row-3 GDN recurrence/short-conv verifier-state restore, Q5_1/Q5_K Qwen3.6 FFN gate/up and fused-SwiGLU down M=4-vs-M=1 projections, and FP16-KV small-M4 attention all match their single-row decode equivalents. The unsafe shortcut is therefore not blocked by those isolated primitives; the remaining issue is the full all-position verifier graph state contract.
