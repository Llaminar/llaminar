...
8. Next: reduce the captured ROCm verifier graph's remaining GPU work in ordinary small-M GEMV groups, especially GDN projection and FFN down/out shapes, then re-run same-binary Qwen3.6 ROCm dense baseline/MTP benchmarks before returning to Phase 14 acceptance.
