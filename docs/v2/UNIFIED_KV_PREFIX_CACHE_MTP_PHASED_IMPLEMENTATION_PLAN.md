...
- Next implementation slice:
  1. add runner-owned speculative GDN/short-conv state slots sized by draft
     depth;
  2. finish replacing verifier-snapshot backing storage with true
     accepted-count plus speculative/accepted state-slot buffers uploaded
