...
| MoE default, 595p/128d | CUDA | Qwen3.6 35B A3B | no MTP | 2154.66 | 109.72 | shared-expert grouped decode default |
| MoE default, 595p/128d | CUDA | Qwen3.6 35B A3B | fixed d1 MTP | 1658.66 | 142.74 | new ratchet, 89.84% accept |
| MoE default, 595p/128d | CUDA | Qwen3.6 35B A3B | dynamic MTP | 1654.85 | 138.29 | depth 1, 85.94% accept |
...
CUDA MoE ratchet: `20260605T030041Z-cuda-shared-expert-grouped-default`,
`20260605T030139Z-cuda-shared-expert-grouped-default-mtp-fixed-d1`,
`20260605T030110Z-cuda-shared-expert-grouped-default-mtp-dynamic`.

| Case | Prefill | Decode | Acceptance |
|---|---:|---:|---:|
| no MTP | 2154.66 | 109.72 | n/a |
| fixed d1 MTP | 1658.66 | 142.74 | 89.84% |
| dynamic MTP | 1654.85 | 138.29 | 85.94% |
...
- Greedy margins show real draft/main disagreement, not mostly tie noise.
...
Dense decode is close; CUDA MoE fixed d1 now edges the llama.cpp MTP d1 anchor,
while dynamic remains acceptance-sensitive. Next targets are controller stability,
verifier/correction costs, prefill gap, and a strict same-prompt comparison.
