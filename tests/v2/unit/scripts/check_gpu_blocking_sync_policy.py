...
ALLOWANCES: tuple[Allowance, ...] = (
    *reviewed(
        "backend_primitive",
        ("src/v2/backends/ComputeBackend.cpp", "CUDAComputeContext::synchronize", "raw_device", 1),
        ("src/v2/backends/ComputeBackend.cpp", "CUDAComputeContext::synchronize", "raw_stream", 1),
        ("src/v2/backends/ComputeBackend.cpp", "ROCmComputeContext::synchronize", "raw_device", 1),
        ("src/v2/backends/ComputeBackend.cpp", "ROCmComputeContext::synchronize", "raw_stream", 1),
        ...
        ("src/v2/backends/cuda/CUDABackend.cu", "CUDABackend::deviceToHostAsync", "raw_stream", 1),
        ("src/v2/backends/cuda/CUDABackend.cu", "CUDABackend::hostToDeviceAsync", "raw_stream", 1),
        ("src/v2/backends/cuda/CUDABackend.cu", "CUDABackend::memsetAsync", "raw_stream", 1),
        ("src/v2/backends/cuda/CUDABackend.cu", "CUDABackend::synchronizeAsync", "raw_device", 1),
    ...
    *reviewed(
        ...
        ("src/v2/kernels/rocm/ops/ROCmEmbeddingKernelT.cpp", "ROCmEmbeddingKernelT::apply_tensor", "raw_stream", 7),
    ),
    *reviewed(
        "graph_ownership",
    ...
    *reviewed(
        "heterogeneous_staging",
        ("src/v2/collective/LocalTPContext.cpp", "LocalTPContext::allreduceOnStream", "backend_device", 1),
        ("src/v2/collective/LocalTPContext.cpp", "LocalTPContext::allreduceOnStream", "raw_stream", 1),
        ...
        ("src/v2/execution/local_execution/orchestrators/LogitsGatherer.cpp", "LogitsGatherer::gatherLocalInfos", "backend_sync_copy", 3),
        ...
        ("src/v2/utils/MPIStager.cpp", "MPIStager::synchronizeDevice", "backend_device", 1),
    ...
    *reviewed(
        ...
        ("src/v2/kernels/cuda/kvcache/CUDARingKVCache.cu", "CUDARingKVCache<Precision>::clear", "raw_stream", 1),
        ("src/v2/kernels/cuda/kvcache/CUDARingKVCacheBase.cpp", "CUDARingKVCacheBase::allocateDeviceParams", "raw_stream", 1),
        ("src/v2/kernels/cuda/kvcache/CUDARingKVCacheBase.cpp", "CUDARingKVCacheBase::clear_sequence", "raw_stream", 1),
        ("src/v2/kernels/cuda/kvcache/CUDARingKVCacheTQ.cu", "CUDARingKVCacheTQ::CUDARingKVCacheTQ", "raw_stream", 2),
        ("src/v2/kernels/cuda/kvcache/CUDARingKVCacheTQ.cu", "CUDARingKVCacheTQ::allocate_entry", "raw_stream", 1),
        ("src/v2/kernels/cuda/kvcache/CUDARingKVCacheTQ.cu", "CUDARingKVCacheTQ::clear", "raw_stream", 1),
        ("src/v2/kernels/cuda/kvcache/CUDARingKVCacheTQ.cu", "CUDARingKVCacheTQ::clear_layer", "raw_stream", 1),
        ("src/v2/kernels/cuda/kvcache/CUDARingKVCacheTQ.cu", "CUDARingKVCacheTQ::clear_sequence", "raw_stream", 2),
        ...
        ("src/v2/kernels/rocm/kvcache/ROCmRingKVCache.cpp", "ROCmRingKVCache<Precision>::clear", "raw_stream", 1),
        ("src/v2/kernels/rocm/kvcache/ROCmRingKVCacheBase.cpp", "ROCmRingKVCacheBase::allocateDeviceParams", "raw_stream", 1),
        ("src/v2/kernels/rocm/kvcache/ROCmRingKVCacheBase.cpp", "ROCmRingKVCacheBase::clear_sequence", "raw_stream", 1),
        ("src/v2/kernels/rocm/kvcache/ROCmRingKVCacheTQ.hip", "ROCmRingKVCacheTQ::ROCmRingKVCacheTQ", "raw_stream", 1),
        ("src/v2/kernels/rocm/kvcache/ROCmRingKVCacheTQ.hip", "ROCmRingKVCacheTQ::clear", "raw_stream", 1),
        ("src/v2/kernels/rocm/kvcache/ROCmRingKVCacheTQ.hip", "ROCmRingKVCacheTQ::clear_layer", "raw_stream", 1),
        ("src/v2/kernels/rocm/kvcache/ROCmRingKVCacheTQ.hip", "ROCmRingKVCacheTQ::clear_sequence", "raw_stream", 2),
