...
class Q2_K_TranscodeTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
    ...
    void RunScalar(const Q2_KBlock &block, int sub_block_idx, float *out_scale, float *out_min)
    {
        // Use the scalar implementation from SIMDHelpers directly as reference for AVX2
        llaminar2::simd::transcode_q2_k_to_int8_scalar(block, sub_block_idx, expected_int8, out_scale, out_min);
    }
...
TEST_F(Q2_K_TranscodeTest, ScalarVsAVX2_Random)
{
#if defined(__AVX2__)
    ...
    for (int i = 0; i < 100; ++i)
    {
        ...
        llaminar2::simd::transcode_q2_k_to_int8_avx2(block, sub_block_idx, actual_int8, &actual_scale, &actual_min);
