/**
 * @file Test__Q5_0_DecodeVectorization.cpp
 * @brief Tests for Q5_0 decode vectorization (SIMD optimizations)
...
class Q5_0_DecodeVectorizationTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
 ...
 */
TEST_F(Q5_0_DecodeVectorizationTest, ScalarVsAVX512_AllValues)
{
    ...
    decode_q5_0_to_q8_0_scalar(input_qs, input_qh, d_fp16, output_scalar, &d_scalar_fp16);
    decode_q5_0_to_q8_0_avx512(input_qs, input_qh, d_fp16, output_avx512, &d_avx512_fp16);
 ...
 */
TEST_F(Q5_0_DecodeVectorizationTest, ScalarVsAVX2_AllValues)
{
#ifdef __AVX2__
    for (int i = 0; i < 16; ++i)
    {
    ...
    decode_q5_0_to_q8_0_scalar(input_qs, input_qh, d_fp16, output_scalar, &d_scalar_fp16);
    decode_q5_0_to_q8_0_avx2(input_qs, input_qh, d_fp16, output_avx2, &d_avx2_fp16);
 ...
 */
TEST_F(Q5_0_DecodeVectorizationTest, AutoDispatch_MatchesScalar)
{
    ...
    decode_q5_0_to_q8_0_scalar(input_qs, input_qh, d_fp16, output_scalar, &d_scalar_fp16);
    decode_q5_0_to_q8_0(input_qs, input_qh, d_fp16, output_auto, &d_auto_fp16);
 ...
 */
TEST_F(Q5_0_DecodeVectorizationTest, ZeroValues)
{
    std::memset(input_qs, 0, sizeof(input_qs));
    std::memset(input_qh, 0, sizeof(input_qh));
    d_fp16 = fp32_to_fp16(1.0f);
    ...
    decode_q5_0_to_q8_0(input_qs, input_qh, d_fp16, output, &d_output_fp16);

    // Q5_0: value 0 maps to -16 after subtraction
    // After quantization to Q8_0 with scale ~1.0, should be near -127 (clamped)
    for (int i = 0; i < 32; ++i)
    {
...
/**
 * @brief Test maximum positive values (nibbles=15, high_bit=1 → value=31-16=15)
 */
TEST_F(Q5_0_DecodeVectorizationTest, MaximumPositive)
{
...
/**
 * @brief Test high bit extraction pattern
 */
TEST_F(Q5_0_DecodeVectorizationTest, HighBitExtraction)
{
 ...
 */
TEST_F(Q5_0_DecodeVectorizationTest, RandomizedFuzz_100Blocks)
{
    std::mt19937 gen(42);
 ...
 */
TEST_F(Q5_0_DecodeVectorizationTest, ScalarPerformance_1000Iterations)
{
 ...
 */
TEST_F(Q5_0_DecodeVectorizationTest, AVX2_Performance_1000Iterations)
{
#ifdef __AVX2__
    std::memset(input_qs, 0xAA, sizeof(input_qs));
    std::memset(input_qh, 0x55, sizeof(input_qh));
 ...
 */
TEST_F(Q5_0_DecodeVectorizationTest, AVX512_Performance_1000Iterations)
{
#if defined(__AVX512F__) && defined(__AVX512BW__)
    std::memset(input_qs, 0xAA, sizeof(input_qs));
    std::memset(input_qh, 0x55, sizeof(input_qh));
