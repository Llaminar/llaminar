...
and deterministic cross-validation ranking. It deliberately excludes corpus
measurement and profiler-model training: its target is the exact-tree CV phase
...
def main() -> int:
    ...
    total_seconds = reduction_complete - started
