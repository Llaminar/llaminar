...
# Check if GPU resource lock is needed
set(_needs_gpu_lock FALSE)
if("${LABELS}" MATCHES "Integration")
    if("${LABELS}" MATCHES "CUDA|ROCm|GPU|HIP|NCCL|RCCL|P2P|CrossVendor|MultiGPU|cuBLAS|hipBLAS")
        set(_needs_gpu_lock TRUE)
    endif()
endif()
...
foreach(_full_name IN LISTS _all_tests)
    ...
    if(_needs_gpu_lock)
        string(APPEND _output "    RESOURCE_LOCK \"GPU_Hardware\"\n")
    endif()
