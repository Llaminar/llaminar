...
if [ ! -f "./build_v2/llaminar2" ]; then
    echo "Error: llaminar2 binary not found at ./build_v2/llaminar2"
    echo "Please build the project first: cmake -B build_v2 -S src/v2 -DCMAKE_BUILD_TYPE=Debug && cmake --build build_v2 --parallel"
    exit 1
fi
