    ...
    private:
                               ...
                               float alpha, float beta)
        {
            ...
            try
            {
                ...
                if (m == 4 && k == 896 && n == 448)
                {
                    LOG_ERROR("[!!!ADAPTIVE_CBLAS!!!] rank " << mpi_rank_ << " Q/K/V projection:");
                    LOG_ERROR("  m=" << m << " n=" << n << " k=" << k);
                    LOG_ERROR("  transpose_A=" << transpose_A << " transpose_B=" << transpose_B);
                    LOG_ERROR("  trans_A=" << (trans_A == CblasTrans ? "Trans" : "NoTrans")
                                           << " trans_B=" << (trans_B == CblasTrans ? "Trans" : "NoTrans"));
                    LOG_ERROR("  lda=" << lda << " ldb=" << ldb << " ldc=" << ldc);
                    LOG_ERROR("  A[0:5]: [" << A[0] << ", " << A[1] << ", " << A[2] << ", " << A[3] << ", " << A[4] << "]");
                    LOG_ERROR("  B[0:5]: [" << B[0] << ", " << B[1] << ", " << B[2] << ", " << B[3] << ", " << B[4] << "]");
                }
                ...
                if (m == 4 && k == 896 && n == 448)
                {
                    LOG_ERROR("  C[0:10]: [" << C[0] << ", " << C[1] << ", " << C[2] << ", " << C[3] << ", "
