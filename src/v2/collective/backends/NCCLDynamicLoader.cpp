/**
 * @file NCCLDynamicLoader.cpp
 * @brief Implementation of dynamic NCCL loader using dlopen/dlsym
 *
 * Uses dlopen with RTLD_LOCAL to load NCCL into an isolated symbol namespace,
 * preventing conflicts with RCCL which exports identical symbol names.
 *
    ...
    namespace nccl_dynamic
    {
        ...
        void unload()
        {
            ...
            if (g_library_handle)
            {
                ...
                LOG_DEBUG("NCCL Dynamic Loader: Library unloaded");
            }
        }
        ...
        // =========================================================================
        // NCCL API Wrapper Implementations
        // =========================================================================
        ...
        ncclResult_t ncclGetUniqueId(ncclUniqueId *uniqueId)
        {
            ...
            {
                LOG_ERROR("NCCL not loaded: ncclGetUniqueId");
        ...
        ncclResult_t ncclCommInitRank(ncclComm_t *comm, int nranks, ncclUniqueId commId, int rank)
        {
            ...
            {
                LOG_ERROR("NCCL not loaded: ncclCommInitRank");
                return ncclInternalError;
            }
        ...
        ncclResult_t ncclCommDestroy(ncclComm_t comm)
        {
            ...
            {
                LOG_ERROR("NCCL not loaded: ncclCommDestroy");
                return ncclInternalError;
            }
        ...
        ncclResult_t ncclCommCount(const ncclComm_t comm, int *count)
        {
            if (!fp_ncclCommCount)
            {
                LOG_ERROR("NCCL not loaded: ncclCommCount");
                return ncclInternalError;
            }
        ...
        ncclResult_t ncclCommCuDevice(const ncclComm_t comm, int *device)
        {
            ...
            {
                LOG_ERROR("NCCL not loaded: ncclCommCuDevice");
                return ncclInternalError;
            }
        ...
        ncclResult_t ncclCommUserRank(const ncclComm_t comm, int *rank)
        {
            ...
            {
                LOG_ERROR("NCCL not loaded: ncclCommUserRank");
                return ncclInternalError;
            }
                                   ...
                                   void *stream)
        {
            if (!fp_ncclAllReduce)
            {
                LOG_ERROR("NCCL not loaded: ncclAllReduce");
                return ncclInternalError;
            }
                                   ...
                                   void *stream)
        {
            if (!fp_ncclBroadcast)
            {
                LOG_ERROR("NCCL not loaded: ncclBroadcast");
                return ncclInternalError;
            }
                                ...
                                ncclComm_t comm, void *stream)
        {
            if (!fp_ncclReduce)
            {
                LOG_ERROR("NCCL not loaded: ncclReduce");
                return ncclInternalError;
            }
                                   ...
                                   ncclDataType_t datatype, ncclComm_t comm, void *stream)
        {
            if (!fp_ncclAllGather)
            {
                LOG_ERROR("NCCL not loaded: ncclAllGather");
                return ncclInternalError;
            }
                                       ...
                                       void *stream)
        {
            ...
            {
                LOG_ERROR("NCCL not loaded: ncclReduceScatter");
                return ncclInternalError;
            }
                              ...
                              int peer, ncclComm_t comm, void *stream)
        {
            if (!fp_ncclSend)
            {
                LOG_ERROR("NCCL not loaded: ncclSend");
                return ncclInternalError;
            }
                              ...
                              int peer, ncclComm_t comm, void *stream)
        {
            if (!fp_ncclRecv)
            {
                LOG_ERROR("NCCL not loaded: ncclRecv");
                return ncclInternalError;
            }
        ...
        ncclResult_t ncclGroupStart()
        {
            ...
            {
                LOG_ERROR("NCCL not loaded: ncclGroupStart");
                return ncclInternalError;
            }
        ...
        ncclResult_t ncclGroupEnd()
        {
            if (!fp_ncclGroupEnd)
            {
                LOG_ERROR("NCCL not loaded: ncclGroupEnd");
                return ncclInternalError;
            }
