...
namespace llaminar2
{
    ...
    bool Q5_0Tensor::set_device(int device_idx)
    {
...
#pragma omp parallel for schedule(static) if (num_elements > 10000)
    ...
    bool Q5_0Tensor::copyFrom(const CPUTensorBase *src)
    {
    ...
    std::shared_ptr<CPUTensorBase> Q5_0Tensor::create_view(
        ...
        size_t offset)
    {
        ...
        std::shared_ptr<CPUTensorBase> parent = is_view_ ? parent_ : std::static_pointer_cast<CPUTensorBase>(shared_from_this());
