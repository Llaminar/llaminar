...
namespace llaminar2
{
    ...
    std::shared_ptr<CPUTensorBase> Q5_KTensor::create_view(
        ...
        size_t offset)
    {
        ...
        if (end_row > shape_[0])
        {
            throw std::out_of_range("Q5_KTensor::create_view: view extends beyond parent bounds");
        }
...
#pragma omp parallel for schedule(static) if (total_elements > 10000)
    ...
    bool Q5_KTensor::copyFrom(const CPUTensorBase *src)
    {
