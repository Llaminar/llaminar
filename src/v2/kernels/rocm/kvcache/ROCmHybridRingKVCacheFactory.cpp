        ...
        std::shared_ptr<PhysicalMemoryAuthority> memory_authority)
    {
        ...
        case ActivationPrecision::FP32:
            return std::make_unique<ROCmHybridRingKVCacheFP32>(
                hybrid_config, n_layers, batch_size, max_seq_len, n_kv_heads,
                head_dim, device_id, memory_authority);
        ...
        std::shared_ptr<PhysicalMemoryAuthority> memory_authority)
    {
        ...
        case ActivationPrecision::FP32:
            return std::make_unique<ROCmHybridRingKVCacheFP32>(
                ...
                n_kv_heads, local_n_kv_heads, kv_head_start, head_dim,
                device_id, memory_authority);
        case ActivationPrecision::FP16:
            return std::make_unique<ROCmHybridRingKVCacheFP16>(
                hybrid_config, n_layers, batch_size, max_seq_len,
                n_kv_heads, local_n_kv_heads, kv_head_start, head_dim,
