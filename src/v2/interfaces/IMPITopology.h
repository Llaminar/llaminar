...
namespace llaminar2
{
    ...
    public:
        ...
        /**
         * @brief Return whether two world ranks share one physical host.
         *
         * This is the authoritative boundary for selecting an inter-process
         * shared-memory protocol.  Rank numbering and sockets are deliberately
         * not used as locality proxies.
         */
        virtual bool same_node(int rank_a, int rank_b) const = 0;

        /**
         * @brief Return a non-zero namespace shared by this run's local ranks.
         *
         * The value is freshly generated by the node leader during topology
         * discovery and broadcast only within the physical node.  It lets
         * independently constructed point-to-point channels derive collision-
         * free POSIX shared-memory names without a hot-path MPI handshake.
         */
        virtual uint64_t node_shared_memory_namespace() const = 0;
