...
namespace llaminar2
{
     ...
     * live-state publication. Every valid plan is publication-ready: grouped
     * verifier paths must make compact outcomes decode-equivalent before
     * constructing this object, rather than carrying an alternate-publication marker
     * through production code. It intentionally owns all intermediate planning
