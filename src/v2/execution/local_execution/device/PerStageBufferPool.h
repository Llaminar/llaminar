 ...
 *
 * Manages separate Qwen2ActivationBuffers for each PP stage, with each
 ...
 * 1. Allocates Qwen2ActivationBuffers per stage
...
public:
    ...
    [[nodiscard]] const Qwen2ActivationBuffers &forStage(int stage_id) const;
    ...
    [[nodiscard]] const Qwen2ActivationBuffers &forLayer(int layer_idx) const;
...
private:
    ...
    std::map<int, Qwen2ActivationBuffers> stage_buffers_;
