    ...
    public:
        ...
        GraphSchema createSchema() const override
        {
            ...
            gdn_template.attention_stages = {
                ...
                StageSpec{
                    .name = "gdn_proj",
                    .type = StageType::GDNProjection,
                    .inputs = {
                        {"normalized", BufferSemantic::Input},
                        {"weights.attn_qkv", BufferSemantic::Input},
                        {"weights.attn_gate", BufferSemantic::Input},
                        {"weights.ssm_alpha", BufferSemantic::Input},
                        {"weights.ssm_beta", BufferSemantic::Input}},
                    .outputs = {
                        {"gdn_qkv", BufferSemantic::Output},
                        {"gdn_z", BufferSemantic::Output},
                        {"gdn_alpha", BufferSemantic::Output},
                        {"gdn_beta", BufferSemantic::Output}},
                ...
                StageSpec{
                    ...
                    .inputs = {
                        {"gdn_qkv", BufferSemantic::InOut},
                        {"weights.ssm_conv1d", BufferSemantic::Input}},
                    .outputs = {{"gdn_qkv", BufferSemantic::InOut}},
                ...
                StageSpec{
                    .name = "gated_norm",
                    .type = StageType::GatedRMSNorm,
                    .inputs = {
                        {"attn_output", BufferSemantic::InOut},
                        {"gdn_z", BufferSemantic::Input},
                        {"weights.ssm_norm", BufferSemantic::Input}},
                    .outputs = {{"attn_output", BufferSemantic::InOut}},
                    .dependencies = {"gdn_recurrence"},
                    .is_optional = true,
                    .exec_policy_key = "exec_gated_rmsnorm"},
                ...
                StageSpec{
                    ...
                    .type = StageType::GEMM,
                    .inputs = {
                        {"attn_output", BufferSemantic::Input},
                        {"weights.ssm_out", BufferSemantic::Input}},
                    .outputs = {{"attn_proj", BufferSemantic::Output}},
                    .dependencies = {"gated_norm"},
                ...
                StageSpec{
                    .name = "attn_output_gate",
                    .type = StageType::AttentionOutputGate,
                    .inputs = {
                        {"attn_proj", BufferSemantic::InOut},
                        {"weights.attn_gate", BufferSemantic::Input}},
                    .outputs = {{"attn_proj", BufferSemantic::InOut}},
                    .dependencies = {"gdn_out_proj"},
                    .is_optional = true,
                    .exec_policy_key = "exec_output_gate"},

                // Attention residual add
                StageSpec{
                    .name = "attn_residual",
                    .type = StageType::ResidualAdd,
                    .inputs = {
                        {"attn_proj", BufferSemantic::Input},
                        {"hidden", BufferSemantic::InOut}},
                    .outputs = {{"hidden", BufferSemantic::InOut}},
                    .dependencies = {"attn_output_gate"},
                    .is_optional = true,
            ...
            fa_template.attention_stages = {
                ...
                StageSpec{
                    .name = "qkv_proj",
                    .type = StageType::FusedQKVGEMM,
                    .inputs = {
                        {"normalized", BufferSemantic::Input},
                        {"weights.wq", BufferSemantic::Input},
                        {"weights.wk", BufferSemantic::Input},
                        {"weights.wv", BufferSemantic::Input}},
                    .outputs = {
                        {"Q", BufferSemantic::Output},
                        {"K", BufferSemantic::Output},
                        {"V", BufferSemantic::Output}},
                    .dependencies = {"attn_norm"},
                    .tp_mode = TPMode::ColumnParallel,
                    .is_optional = true,
                    .exec_policy_key = "exec_gemm"},
                ...
                StageSpec{
                    .name = "q_norm",
                    .type = StageType::QKNorm,
                    .inputs = {
                        {"Q", BufferSemantic::InOut},
                        {"weights.q_norm", BufferSemantic::Input}},
                    .outputs = {{"Q", BufferSemantic::InOut}},
                    .dependencies = {"qkv_proj"},
                    .is_optional = true,
                    .exec_policy_key = "exec_rmsnorm"},
                ...
                StageSpec{
                    ...
                    .type = StageType::QKNorm,
                    .inputs = {
                        {"K", BufferSemantic::InOut},
                        {"weights.k_norm", BufferSemantic::Input}},
                    .outputs = {{"K", BufferSemantic::InOut}},
                    .dependencies = {"qkv_proj"},
                    .is_optional = true,
                    .exec_policy_key = "exec_rmsnorm"},
                ...
                StageSpec{
                    ...
                    .is_optional = true,
                    .exec_policy_key = "exec_rope"},

                // KV Cache append
                StageSpec{
                    .name = "kv_append",
                    .type = StageType::KVCacheAppend,
                    .inputs = {
                        {"K", BufferSemantic::Input},
                        {"V", BufferSemantic::Input},
                        {"kv_cache", BufferSemantic::InOut}},
                    .outputs = {},
                    .dependencies = {"rope"},
                ...
                StageSpec{
                    .name = "attention",
                    .type = StageType::AttentionCompute,
                    .inputs = {
                        {"Q", BufferSemantic::Input},
                        {"K", BufferSemantic::Input},
                        {"V", BufferSemantic::Input}},
                    .outputs = {{"attn_output", BufferSemantic::Output}},
                    .dependencies = {"kv_append"},
                    .is_optional = true,
                ...
                StageSpec{
                    ...
                    .inputs = {
                        {"attn_output", BufferSemantic::Input},
                        {"weights.wo", BufferSemantic::Input}},
                    .outputs = {{"attn_proj", BufferSemantic::Output}},
            ...
            schema.lm_head_stages = {
                ...
                StageSpec{
                    ...
                    .inputs = {
                        {"hidden", BufferSemantic::Input},
                        {"weights.lm_head", BufferSemantic::Input}},
                    .outputs = {{"logits", BufferSemantic::Output}},
            ...
            schema.layer_buffers = {
                ...
                {"gdn_qkv", {"seq_len", "gdn_inner_size_x2"}, "fp32", BufferSemantic::Scratch, "gdn_scratch", 10, "GDN fused QKV"},
            ...
            schema.model_buffers = {
                ...
                {"logits", {"seq_len", "vocab_size"}, "fp32", BufferSemantic::Output, "", 0, "Final logits"},
        ...
        bool isWeightOptional(const std::string &gguf_weight_name) const override
        {
            ...
            // post_attention_norm is on all layers
            if (gguf_weight_name.find("post_attention_norm.weight") != std::string::npos)
            {
                return true;
            }
    ...
    private:
        ...
        static std::vector<StageSpec> buildFFNStages()
        {
            return {
                ...
                StageSpec{
                    .name = "gate_up_proj",
                    .type = StageType::FusedGateUpGEMM,
                    .inputs = {
                        {"normalized", BufferSemantic::Input},
                        {"weights.gate_proj", BufferSemantic::Input},
                        {"weights.up_proj", BufferSemantic::Input}},
                    .outputs = {
                        {"gate", BufferSemantic::Output},
                        {"up", BufferSemantic::Output}},
                    .dependencies = {"ffn_norm"},
                    .tp_mode = TPMode::ColumnParallel,
                    .is_optional = true,
                    .exec_policy_key = "exec_gemm"},
                ...
                StageSpec{
                    .name = "swiglu",
                    .type = StageType::SwiGLU,
                    .inputs = {
                        {"gate", BufferSemantic::Input},
                        {"up", BufferSemantic::InOut}},
                    .outputs = {{"up", BufferSemantic::InOut}},
                ...
                StageSpec{
                    ...
                    .type = StageType::GEMM,
                    .inputs = {
                        {"up", BufferSemantic::Input},
                        {"weights.down_proj", BufferSemantic::Input}},
                    .outputs = {{"attn_proj", BufferSemantic::Output}},
                    .dependencies = {"swiglu"},
                    .tp_mode = TPMode::RowParallel,
                    .is_optional = true,
